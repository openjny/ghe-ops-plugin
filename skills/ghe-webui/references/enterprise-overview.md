...
| リンク | URL | 説明 |
|--------|-----|------|
| Enterprise changelog | `https://github.blog/changelog/label/enterprise/` | 新機能・変更のリリースノート |
| GitHub Support | `https://support.github.com` | サポートリソース・問い合わせ |
| Documentation | `https://docs.github.com/enterprise-cloud@latest` | GHEC ドキュメント |

---

[^1]: [GitHub Docs: Enterprise accounts](https://docs.github.com/enterprise-cloud@latest/admin/managing-your-enterprise-account/about-enterprise-accounts)
